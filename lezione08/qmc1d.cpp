...
{
/*	double k_elastic = 1;		//elastic potential
...
/*	double k_elastic=1;		//elastic potential
	return k_elastic;*/
	return 12.*val*val-5.;		//x^4-5/2*x^2
}
...
{
//	return 1.0;			//costant wave function
//	return exp(-0.5*v*v);		//harmonic oscillator GS
	double mu=0.8,sigma=0.62;	//x^4-5/2*x^2 best variational
...
{
//	return 0;			//costant wave function
//	return v*v*exp(-0.5*v*v)-exp(-0.5*v*v);//harmonic oscillator GS
	double mu=0.8,sigma=0.62;	//x^4-5/2*x^2 best variational
	double sig2=sigma*sigma;
